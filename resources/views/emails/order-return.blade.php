@component('mail::message')
    ...
    <strong style="direction: rtl; float: right;"> {{ trans('general.name') }} / {{ $name }}</strong><br><br>
    ...
    <strong style="direction: rtl; float: right;"> {{ trans('general.purchase_date') }} / {{ $purchase_date }}</strong>
    <br>
    @if($notes)
