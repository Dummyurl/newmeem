        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="left-layout">
                            <div class="price-filter-area single-layout">
                                @include('____frontend.partials._product_index_categories')
                                @include('____frontend.partials._product_index_brands')
                                @include('____frontend.partials._product_index_sizes')
                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                    <!--breadcrumbs start-->
                @include('____frontend.partials._breadcrumbs',['name' => trans('general.search_results')])
                <!--breadcrumbs end-->
                    <div class="layout-title bottom-tag">
                        ...
                        <!-- Tab Content -->
                            ...
                            <div class="tab-content">
                                <div id="shop-grid" class="tab-pane active" role="tabpanel">
                                    <div class="row">
                                        @include('____frontend.modules.product.partials.product_category',['products' => $elements ,'cols' => 'col-lg-4 col-md-4 col-sm-6'])
                                    </div>
                                </div>
                            </div>
